...
public class TestConfig{
	...
	public static String from = "aditynaik1@gmail.com";
	public static String password = "Aditya1!";
	public static String[] to ={"adityanaik1@gmail.com","aditya.naik@publicissapient.com"};
